...
CRONJOBS = [
    ...
    ('*/30 * * * *', 'onedollar.models.pns_free_daily_cat', '>> /webapps/onedollar_backend/logs/cron.log 2>&1'),
    ('*/30 * * * *', 'onedollar.models.pns_spin_cat_uncage', '>> /webapps/onedollar_backend/logs/cron.log 2>&1'),
    ('*/30 * * * *', 'onedollar.models.pns_uncage_cat_remind', '>> /webapps/onedollar_backend/logs/cron.log 2>&1'),
